LinkLuaModifier( "modifier_npc_dota_hero_juggernaut_permanent_ability", "heroes/hero_juggernaut/hero_juggernaut", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_imba_omni_slash_caster", "heroes/hero_juggernaut/hero_juggernaut", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_omni_slash_image", "heroes/hero_juggernaut/hero_juggernaut", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omnislash_image_afterimage_fade", "heroes/hero_juggernaut/hero_juggernaut", LUA_MODIFIER_MOTION_NONE)

npc_dota_hero_juggernaut_permanent_ability = class({})

function npc_dota_hero_juggernaut_permanent_ability:OnHeroLevelUp()
	if IsServer() then
...
function npc_dota_hero_juggernaut_permanent_ability:GetIntrinsicModifierName()
	return "modifier_npc_dota_hero_juggernaut_permanent_ability"
end

---------------------------------------------------------------------------------------------------------------

modifier_npc_dota_hero_juggernaut_permanent_ability = class({})

function modifier_npc_dota_hero_juggernaut_permanent_ability:IsHidden()
	return true
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:IsDebuff()
	return false
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:IsPurgable()
	return false
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:RemoveOnDeath()
	return false
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:OnCreated( kv )
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:OnRefresh( kv )
	self:OnCreated( kv )
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:DeclareFunctions()
	return {MODIFIER_EVENT_ON_ATTACK_LANDED}
end

function modifier_npc_dota_hero_juggernaut_permanent_ability:OnAttackLanded(keys)
	...
	local point = keys.target:GetAbsOrigin()
		...
		local trail_pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_juggernaut/juggernaut_omni_slash_trail.vpcf", PATTACH_ABSORIGIN, keys.attacker)
